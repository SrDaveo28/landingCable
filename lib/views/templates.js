...
export function aboutUs() {
    ...
    <main class="main">
        ...
        <!--=============== promo hernandarias ===============-->
        <section class="home section" id="promo">
            <div class="home__container container grid">
                <div>
                    <img src="assets/img/img/promoHernandarias.jpg" alt="" class="home__img">
                </div>

                <div class="home__data">
                    <div class="home__header">
                        <h1 class="home__title">Promo</h1>
                        <h2 class="home__subtitle">6 Meses a 100mil</h2>
                    </div>

                    <div class="home__footer">
                        <h3 class="home__title-description">100 Megas a tan solo 100mil guaraníes</h3>
                        <p class="home__description">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                            Exercitationem autem laboriosam molestiae quidem unde esse amet repudiandae, cum, quibusdam
                            vitae quae illo eos? Illo minima vel, animi iusto eaque eligendi.
                        </p>
                        ...
                        <a href="#" class="button button--flex">
                            <i class="ri-information-line button__icon"></i> ¡Me interesa!
                        </a>
                    </div>
                </div>
            </div>
