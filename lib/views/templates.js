...
export function sectionHeader() {
    return /* html */`
        ...
        <div class="text">
            ...
            <p>Internet por Fibra Óptica + un Plan de Canales de distribución gratuita, canales nacionales de Paraguay, Brasil y Argentina, mas canales de variedad de diferentes países. (Ciudad del Este).</p>

            <a href="#about">Conozca Más</a>
    ...
    <header  id="header">
        <nav class="nav container">
            <a href="#" class="nav__logo">
                <img src="assets/img/logo_cde_BR.png" alt="" class="menu__logo">
            </a>
    ...
    <main class="main">
            ...
            <div class="home__container container grid">
                ...
                <div class="home__data">
                    ...
                    <div class="home__footer">
                        <h3 class="home__title-description">Cable Digital del Este</h3>
                        <p class="home__description">Somos una empresa dedicada a brindar el servicio mas conveniente, con la 
                        mejor calidad y con el trato mas ameno en Alto Paraná.
                        </p>
        ...
        <section class="case section grid">
            ...
            <div class="case__container container grid">
                ...
                <div class="case__data">
                    <p class="case__description">Brindamos los planes de internet por fibra óptica que mas te convienen.
                    </p>
        ...
        <section class="case section grid">
            ...
            <div class="case__container container grid">
                ...
                <div class="case__data">
                    <p class="case__description">No pagues demás, todos nuestros planes básicos Incluyen el TV cable! 
                    Consulta la cobertura de nuestros servicios.
                    </p>
                    <a href="#" class="button button--flex">
                        <i class="ri-information-line button__icon"></i> Más Info
                    </a>
                        ...
                        <div class="screen-body">
                            ...
                            <div class="screen-body-item">
                                <div class="app-form">
                                    ...
                                    <div class="app-form-group">
                                        <input class="app-form-control" id="phoneNumber"
